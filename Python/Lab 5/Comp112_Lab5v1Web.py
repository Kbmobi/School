...
def selected_option(n):
    if n == 1:
        n = getInt('input the length of the bottom side: ', 'invalid option')
        if n > 0:
            if n % 2 == 1:
                eTriangle(n)
                return restart()
            ...
            return restart()
    if n == 2:
        n = getInt('input the length of the middle of the diamond: ', 'invalid option')
        if n > 0:
            if n % 2 == 1:
                eDiamond(n)
                return restart()
            ...
            return restart()
    if n == 3:
        out =  getInt('input the length of the outside square: ', 'error')
        inside =  getInt('input the length of the inside square: ', 'error')
        if out % 2 == inside % 2:
            hSquare(out, inside)
            return restart()
        else:
    ...
    if n == 5:
        ...
        print '*                              *'
        print '********************************\n\n'
        x =  getInt('What method would you like to try?: ', 'error')
        if 3 < x < 0:
            print 'invalid option\n'
            selected_option(5)
        else:
            print "\n\n"
            n =  getInt('What number do you want to check?: ', 'error')
            if x == 1:
                tDivPrime(n)
            else:
...
def start():  
    ...
    print "\\--------------------------------------------/"
    print "\n\n"
    n =  getInt('Please select an option now: ', 'error') 
